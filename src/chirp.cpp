...
//data is sysfs path
//dev_apth
//data = "/sys/bus/iio/devices/iio:device0" - > sysfs path
//dev path = /dev/iio:device0
...
int Chirp::init(){
    ...
    std::cout << "!!!!finished firmware" << std::endl;
    index = 0;
    counter = freq*dur;
    int sample = 255;
